...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-black transition-colors">
      <header className="border-b border-slate-200 bg-white dark:border-neutral-800 dark:bg-neutral-900 sticky top-0 z-30">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <span className="hidden sm:flex items-center gap-1.5 text-sm text-slate-500 dark:text-slate-400">
              ...
              <span className="badge bg-slate-100 text-slate-600 dark:bg-neutral-800 dark:text-slate-300">
        ...
        {/* Mobile nav drawer */}
        {mobileOpen && (
          <div className="md:hidden border-t border-slate-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-4 py-3 flex flex-col gap-1">
            {navLinks}
            <div className="pt-2 mt-1 border-t border-slate-200 dark:border-neutral-800 flex items-center justify-between">
